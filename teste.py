...
frame = ctk.CTkFrame(master = janela,fg_color="#2c2c2c",)
frame.place(relx=0.5, rely=0.5, anchor=ctk.CENTER) 

texto = ctk.CTkLabel(frame, text="Cadastrar conta")
texto.pack(padx=10, pady=10)

nome_entry = ctk.CTkEntry(frame, placeholder_text="Nome do usuário ")
nome_entry.pack(padx=10, pady=10)

login_entry = ctk.CTkEntry(frame, placeholder_text="Crie seu login")
login_entry.pack(padx=10, pady=10)

senha_entry = ctk.CTkEntry(frame, placeholder_text="Crie sua senha", show="*")
senha_entry.pack(padx=10, pady=10)

botao = ctk.CTkButton(frame, text="cadastrar", command=clique, fg_color="#8A2BE2")
